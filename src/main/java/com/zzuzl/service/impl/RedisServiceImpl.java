...
public class RedisServiceImpl implements RedisService {
    ...
    public synchronized void syncLikeAndCommentToMysql() {
        Map<Object,Object> map = (Map<Object,Object>) redisTemplate.boundHashOps(Constants.HASH_LIKE).entries();
